<?php
    ...
    class Identity extends \CUserIdentity
    {
        ...
        /**
         * @access protected
         * @var integer $id "The user's ID, an integer taken from the primary key column of the user database table."
         */
        protected $id;
         ...
         * Invalid IP
         *
         * The error code for when a user is not allowed to log in from the current IP address.
         */
         ...
         * Throttled
         *
         * The error code for when a user's ability to login has been temporarily throttled, and they must wait a
         * certain time limit before they will be allowed to login again.
         */
         ...
         * Invalid ID
         *
         * The error code for when a user ID specified does not exist. This does not happen through normal credential
         * authentication; only through internal identity loading.
         */
         ...
         * Inactive User
         *
         * The error code for when a user has been deactivated in the database. Their creditials will not have been
         * checked if this is returned.*/
        const ERROR_INACTIVE    = 6;
         ...
         * More specifically, we want the user ID to be an integer, not a string.
         *
         * @access public
         * @return integer
         */
        ...
        *
        * @access public
        * @param integer|string $id "The user identifier; the user ID if an integer is passed, the username otherwise."
        * @return boolean
        */
         ...
         *
         * @access public
         * @param \CEvent $event "The event object created for this handler to process."
         * @return void
         */
