<?php
    ...
    class Request extends \CHttpRequest
    {
         ...
         * @return string|null
         */
        public function getApplicationReferrer($default = null)
        {
            if($this->applicationReferrer === null) {
                ...
                // If the referrer of this request was a page belonging to this application, use that. Otherwise set it
                // to false so that we know the referrer was not from out application and don't try to calculate again.
                $this->applicationReferrer = is_string($referrer) && substr($referrer, 0, strlen($base)) === $base
                    ? $referrer
                    : false;
            }
            return $this->applicationReferrer !== false
                ? $this->applicationReferrer
                : $default;
        }
