        ...
        public function up()
        {
            $this->createTable(
                ...
                array(
                    ...
                    'timestamp' => 'DOUBLE          NOT NULL            COMMENT "The micro timestamp of the of failed login attempt."',
                    ...
                    'ip'        => 'BINARY(16)      NOT NULL            COMMENT "The IP address that the failed login attempt originated from."',
            ...
            $this->addForeignKey('failed_logins_user_fk', '{{failed_logins}}', 'user', '{{users}}', 'id');
        }
